...
F8_private = setPheno(F8_private,reps=2) # Winter
...
F7_private = setPheno(F7_private,reps=2) # Winter
...
F6_private = setPheno(F6_private,reps=2) # Winter
...
F5_private = setPheno(F5_private,reps=2) # Winter
...
F4_private = setPheno(F4_private,reps=2) # Winter
...
F3_private = setPheno(F3_private,reps=1) # Winter
...
F2_private = setPheno(F2_private,reps=1) # Winter
