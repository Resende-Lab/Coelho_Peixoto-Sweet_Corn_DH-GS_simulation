...
#----------
TS_pop3 = setPheno(TC3_DH,reps=2, p=pgy) # Winter
#----------
...
DH_Pub3 = selectInd(DH_Pub2,nInd=200,use="ebv")

TC2_DH = setPhenoGCA(DH_Pub3,Tester2_private,reps=repTC2,p=pgy)

# Winter = Evaluate testcross 2
TC2_DH = selectInd(TC2_DH,nInd=30)

#----------
TS_pop2 = setPheno(TC2_DH,reps=2,p=pgy) # Winter
#----------
...
###GS model
gsModel = RRBLUP(c(TS_pop1,TS_pop2,TS_pop3), use = "pheno", snpChip = 1) # Winter
