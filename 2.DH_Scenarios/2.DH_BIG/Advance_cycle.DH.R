...
PublicInbredYT3 = selectInd(PublicInbredYT2, 20*nBIG, use="pheno") # Winter
...
PublicInbredYT1Sel = selectInd(PublicInbredYT1, nInd=800*nBIG) # Fall
...
PublicInbredYT2 = selectInd(PublicInbredYT1Sel,  150*nBIG, use = "pheno")
