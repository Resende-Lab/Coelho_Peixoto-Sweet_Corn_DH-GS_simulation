...
F9_public.TC = selectInd(F9_public.sel,nInd=2*nBIG, selectTop = TRUE) # Winter
...
F7_public.TC = selectInd(F7_public.sel, nInd=15*nBIG, selectTop = TRUE) # Winter
...
F5_public.TC = selectInd(F5_public2TC,nInd=100*nBIG, selectTop = TRUE) # Winter
...
F5_public.sel = selectInd(F5_public.sel, nInd = 150*nBIG, selectTop = TRUE, use="ebv") # Winter
